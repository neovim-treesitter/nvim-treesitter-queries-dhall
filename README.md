# nvim-treesitter-queries-dhall

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-dhall/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-dhall/actions/workflows/validate.yml)

Neovim tree-sitter queries for **dhall**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-dhall",
...
- [ ] Changes are scoped to `dhall` — do not include files for other languages
